...
def main(page: ft.Page):
    ...
    txt_acerto = ft.Container(
        ft.Text("Produto Salvo com sucesso!"),
        visible=False,
    ...
    produto = ft.TextField(
        label="Digite o nome do produto...", text_align=ft.TextAlign.LEFT
    )
    ...
    page.add(txt_acerto, txt_erro, txt_titulo, produto, txt_preco, preco, btn_produto)
